...
def do_grid_search_ridge(X_train, y_train, X_val, y_val, l2reg = np.concatenate((10.**np.arange(-6,1,1), np.arange(1,3,.3)))):
    ...
    # to be here.
    param_grid = [{'l2reg':np.unique(l2reg) }]
